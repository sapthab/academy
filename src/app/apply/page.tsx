...
export const metadata: Metadata = {
  title: "Apply Now — Admissions Open at AGS Academy Pondicherry",
  description:
    "Apply to AGS Academy's AI programs in Pondicherry. Simple 3-step admission: apply online, free counselling call, seat confirmation. Batches capped at 50 students.",
};
